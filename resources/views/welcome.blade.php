    ...
    @foreach ($data as $item)
        ...
        <li class="list-group-item collapse" id="collapse-{{ $loop->index }}">
            <form action="{{ route('todo.update', ['id' => $item->id]) }}" method="POST">
                ...
                <div class="d-flex flex-column">
                    <div class="mb-2">
                        <input type="text" class="form-control mb-2" name="task" value="{{ $item->task }}">
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="d-flex align-items-center">
                        <button class="btn btn-outline-primary me-2" type="submit">Update</button>
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_done" id="is_done_{{ $item->id }}"
                                value="1" {{ $item->is_done == '1' ? 'checked' : '' }}>
                            <label class="form-check-label" for="is_done_{{ $item->id }}">Selesai</label>
                        </div>
                    </div>
                </div>
            </form>
                            ...
                            @foreach ($data as $item)
                                ...
                                <li class="list-group-item collapse" id="collapse-{{ $loop->index }}">
                                    <form action="{{ route('todo.update', ['id' => $item->id]) }}" method="POST">
                                        ...
                                        @method('put')
                                        <div class="mb-3">
                                            <input type="text" class="form-control mb-2" name="task" value="{{ $item->task }}" required>
